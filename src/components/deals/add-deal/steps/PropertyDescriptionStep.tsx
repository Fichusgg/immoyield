    ...
    <div className="space-y-10">
      <section>
        ...
        <div className="mt-5 space-y-6">
          <div className="grid grid-cols-[220px_1fr] items-start gap-8">
            <div>
              <label className="text-sm font-semibold text-[#1a1a1a]">Nome do Imóvel</label>
              <p className="mt-1 text-xs text-[#737373]">Aparecerá no painel e nos relatórios.</p>
            </div>
            <div>
              <input
                className="h-12 w-full rounded-xl border border-[#e5e5e3] bg-white px-4 text-sm outline-none transition-shadow focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
          ...
          <div className="grid grid-cols-[220px_1fr] items-start gap-8">
            <div>
              <label className="text-sm font-semibold text-[#1a1a1a]">Descrição Resumida</label>
            ...
            <div>
              <textarea
                rows={5}
                className="w-full resize-none rounded-xl border border-[#e5e5e3] bg-white px-4 py-3 text-sm leading-6 outline-none transition-shadow focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
          ...
          <div className="grid grid-cols-[220px_1fr] items-start gap-8">
            <div>
              <label className="text-sm font-semibold text-[#1a1a1a]">Tags e Etiquetas</label>
              <p className="mt-1 text-xs text-[#737373]">
            ...
            <div>
              ...
              {errors.property?.tags?.message && (
                <p className="mt-2 text-xs font-semibold text-red-600">{errors.property.tags.message}</p>
              )}
            </div>
          </div>
        </div>
      ...
      <section className="rounded-2xl border border-[#e5e5e3] bg-[#f5f5f3] p-6">
        ...
        <p className="mt-2 text-sm text-[#1a1a1a]">
          Use uma convenção de nomenclatura consistente (endereço + número de unidades) para manter seu portfólio organizado.
        </p>
      </section>
    </div>
  );
