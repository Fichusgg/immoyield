  ...
  return (
    <>
      ...
      <div className="mb-8 grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        />
        <KpiCard label="Cap Rate" value={pct(m.capRate)} />
        <KpiCard label="Cash-on-Cash" value={pct(m.cashOnCash)} />
      </div>
      ...
      <FormCard className="mb-6">
        <SummaryRow label="Cap Rate" value={pct(m.capRate)} accent />
        <SummaryRow label="Cash-on-Cash" value={pct(m.cashOnCash)} accent />
        {m.irrAnnual != null && (
          <SummaryRow label="TIR (IRR Anual)" value={pct(m.irrAnnual)} accent />
        )}
